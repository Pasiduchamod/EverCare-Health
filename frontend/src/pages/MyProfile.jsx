    ...
    <div>
      ...
      :<p className='text-gray-400'>{userData.gender}</p>
        ...
        <div className='mt-10'>
          {
            isEdit
            ?<button className='text-black-400 border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all' onClick={updateUSerProfileData}>Save Information</button>
